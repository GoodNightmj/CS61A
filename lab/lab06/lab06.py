...
class BankAccount:
    ...
    def __init__(self, account_holder):
        ...
        self.transactions = []  # A list of Transaction instances
...
class Server:
    ...
    def send(self, email):
        ...
        if recipient_name in self.clients:
            client = self.clients[recipient_name]
...
class Mint:
    ...
    def update(self):
        ...
        "*** YOUR CODE HERE ***"
        Mint.present_year = self.year  # Update the present year to the mint's year
